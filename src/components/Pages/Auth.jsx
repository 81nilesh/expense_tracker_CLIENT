    ...
    const AuthHandler = async (obj) => {
        try {
            if (login) {
                ...
                setSendingReq(true);
                const response = await axios.post(`https://expenseapimac.onrender.com/users/login`, obj);
                setSendingReq(false);
                ...
                setSendingReq(true);
                const response = await axios.post(`https://expenseapimac.onrender.com/users/signup`, obj);
                setAlertSeverity('success');
                setAlertMsg(response.data.msg);
                setSendingReq(false);
                setLogin(true);
