...
const Profile = () => {
    ...
    useEffect(() => {
        const getPrevProfileDB = async () => {
            try {
                ...
                const response = await axios.get('https://expenseapimac.onrender.com/users/profile/getProfile',{ headers: { "Authorization": token } });
    ...
    const formSubmitHandler = async (e) => {
        ...
        try {
            ...
            const token = JSON.parse(localStorage.getItem('token'));
            await axios.post('https://expenseapimac.onrender.com/users/profile/complete', obj, { headers: { "Authorization": token } });
